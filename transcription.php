...
<div class="container">
    ...
    <a id="downloadButton" type="hidden" class="btn btn-primary mt-2 w-100" style="display:none;" download="">⬇️ Télécharger</a>
    ...
    <a id="textButton" type="hidden" class="btn btn-secondary mt-2 w-100" style="display:none;" download="">📄 Télécharger le Texte</a>
    <div class="back-btn">
        ...
        navigator.mediaDevices.getUserMedia({ audio: true }).then(stream => {
            ...
            mediaRecorder.onstop = async () => {
                ...
                try {
                    ...
                    console.log('Upload du fichier texte réussi !', textData.Location);
